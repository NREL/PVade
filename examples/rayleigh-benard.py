...
# Ra = Constant(1e8)
Ra = Constant(mesh, PETSc.ScalarType(1e6))
...
S = FunctionSpace(mesh, s_cg1) # temperature
...
bot_wall_temp = 0.5 #10 # TODO - change this to expression

bottom_wall_dofs = locate_dofs_geometrical(S, bottom_wall)
bcT_bottom_wall = dirichletbc(PETSc.ScalarType(bot_wall_temp), bottom_wall_dofs, S)

top_wall_dofs = locate_dofs_geometrical(S, top_wall)
bcT_top_wall = dirichletbc(PETSc.ScalarType(0), top_wall_dofs, S)
