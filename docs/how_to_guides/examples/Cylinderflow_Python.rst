...
This page documents the standalone script ``examples/cylinderflow.py``.
...
.. code-block:: bash
   ...
   conda run -n PVade python examples/cylinderflow.py

Vortex Shedding Animation
-------------------------

The animation below (``examples/mesh_with_bc.mp4``) shows vorticity shading as
