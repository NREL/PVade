    ...
    def _set_length_scales_mod(self):
        ...
        if self.mesh_comm.rank == self.model_rank:
            ...
            if 'cylinder2d' in self.params.general.example:
                ...
                self.pv_model.mesh.field.setNumber(2, "LcMax", 3.0 * self.params.domain.l_char)
                self.pv_model.mesh.field.setNumber(2, "DistMin", 2.0 * self.cyld_radius)
                self.pv_model.mesh.field.setNumber(2, "DistMax", 10.0 * self.cyld_radius)

            else:
                self.pv_model.mesh.field.setNumber(2, "LcMin", 0.2*self.params.domain.l_char)
                self.pv_model.mesh.field.setNumber(2, "LcMax", 3.0 * self.params.domain.l_char)
                self.pv_model.mesh.field.setNumber(2, "DistMin", .5 * self.params.domain.l_char)
                self.pv_model.mesh.field.setNumber(2, "DistMax", 1. * self.params.domain.l_char)
            ...
            self.pv_model.mesh.field.setNumber(4, "LcMin", 5.0 * self.params.domain.l_char)
            self.pv_model.mesh.field.setNumber(4, "LcMax", 10.0 * self.params.domain.l_char)
            ...
            self.pv_model.mesh.field.setNumber(6, "LcMin", 2.0 * self.params.domain.l_char)
            self.pv_model.mesh.field.setNumber(6, "LcMax", 5.0 * self.params.domain.l_char)
